...
const projects: Project[] = [
  {
    name: "Эльбрус",
    description: "Система искусственного снегообразования и Альп-городок",
    image: elbrusImage,
    ...
    details: {
      ...
      sections: [
        {
          heading: "Снег, который всегда есть: Система искусственного снегообразования",
          content: "Мы бросили вызов самой высокой вершине Европы и создали то, что казалось невозможным — самую высокогорную в Европе систему искусственного снегообразования. Это не просто трубы и пушки. Это сложнейший организм, который вдыхает жизнь в трассы, когда природа берет паузу.\n\nНаша система искусственного снегообразования — это гарантия вашего идеального катания с ноября по май. Это километры трасс, покрытых идеальным снегом, который не тает под ярким горным солнцем. Мы не ждем милости от природы — мы создаем ее для вас, превращая каждый день в лучший день для катания."
        },
        {
